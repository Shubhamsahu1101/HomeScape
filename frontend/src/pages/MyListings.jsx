        ...
        <div className='flex flex-col gap-4 mx-auto max-w-xl md:max-w-2xl lg:max-w-4xl'>
            ...
            {userListings.map((listing) => (
                <div key={listing._id} className='flex gap-2 items-center'>
                    <Link to={`/listing/${listing._id}`} className='hover:opacity-95 bg-slate-100 border rounded-lg p-3 flex flex-auto justify-between items-center gap-4'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <Link to={`/update-listing/${listing._id}`} className='hover:opacity-95 bg-green-500 w-32 border rounded-lg p-3 flex justify-center items-center gap-4' >
                            <p className='text-white'>UPDATE</p>
                        </Link>
                        <div onClick={() => handleListingDelete(listing._id)} className='hover:opacity-95 bg-red-500 w-32 border rounded-lg p-3 flex justify-center items-center gap-4' >
